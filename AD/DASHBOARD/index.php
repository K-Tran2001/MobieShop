                ...
                <script type="text/javascript">
                    ...
                    function drawChart() {
                        var data = google.visualization.arrayToDataTable([
                            ...
                            <?php
                                include '../../config2.php';
                                $sql="select c.CNAME,COUNT(*) as COUNT from category c inner join product p on c.CATEGORY_ID=p.CATEGORY_ID 
                                GROUP by c.CATEGORY_ID";
                
                                $list=mysqli_query($conn,$sql);
                                $response=array();
                                while($row=mysqli_fetch_assoc($list)){
                                    echo "['".$row['CNAME']."',".$row['COUNT']."],";
                                }    
                            ?>
                        ...
                        var options = {
                            title: 'Quantity Statistics by Category',
                            is3D: true,
                        };
