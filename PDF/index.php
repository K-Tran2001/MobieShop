...
<div class="container ">
    <div class="card-content table-responsive">
        ...
        <div class="row">
            <div class="col-sm-4">
                Customer name:'.$row['FIRST_NAME'].'-'.$row['LAST_NAME'].'  <br>
                Adress:'.$row['PROVINCE'].'-'.$row['CITY'].' <br>
        ...
        <div class="row">
            ...
            <div class="col-sm-4 py-1">
                ...
                <table width="100%">
                    ...
                    <td class="text-right">$'.$addVAT.'</td>
                    </tr>
                    <tr>
                    <td class="font-weight-bold">Total</td>
                    <td class="font-weight-bold text-right text-primary">$ '.$total.'</td>
                    </tr>
                </tbody></table>
            </div>
